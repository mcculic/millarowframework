namespace Millarow.Win32.User32
{
    ...
    {
        public const int SW_ERASE = 0x0001; /* Scroll children within *lprcScroll. */
        public const int SW_INVALIDATE = 0x0002; /* Invalidate after scrolling */
        public const int SW_SCROLLCHILDREN = 0x0004;  /* If SW_INVALIDATE, don't send WM_ERASEBACKGROUND */
